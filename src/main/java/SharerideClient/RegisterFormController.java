...
public class RegisterFormController {
     ...
     * nowo rejestrującego się użytkownika za pomocą metody: {@linkplain ServerController#sendRegisterInfoToServer(String, String, String, String, LocalDate, String, java.sql.Date)} do serwera.
     * Metoda sprawdza, czy wszystkie wymagane pola rejestracyjne zostały uzupełnione za pomocą metody {@linkplain  RegisterFormController#checkIfEmpty()}. Następnie
     ...
     * za pomocą metod: {@linkplain RegisterFormController#checkMail()}, {@linkplain RegisterFormController#checkName()}, {@linkplain RegisterFormController#checkPassword()}
     * {@linkplain RegisterFormController#checkLastName()} {@linkplain RegisterFormController#checkPhoneNumber()} kolejnym krokiem jest sprawdzenie, czy użytkownik posiada 18 lat, jeżeli
     * wszystkie warunki zostaną spełnione wyświetla się okno modalne, którym zarządza klasa {@linkplain RegulationsController}.
     ...
     * @see RegulationsController#accepted
     * @see ServerController
     * @see ServerController#sendRegisterInfoToServer(String, String, String, String, LocalDate, String, java.sql.Date)
     * @see ServerController#displayRegistrationServerFeedback(boolean)
     * @see ServerController#getRegisterFeedBackFromServer()
     * @author Karol Przygoda
     */
    @FXML
     ...
     * <p>
     * Metoda ta tworzy nowa Scene jako okno modalne, do którego przekazywany jest plik fxml z zawartością warunków użytkowania checkboxem potwierdzenia
     * przyciskiem potwierdzenia oraz anulowania. Metoda ta jest ostatnim etapem rejestracji. Jeżeli użytkownik
     * zaakceptował warunki użytkowania metoda pobiera wprowadzone dane przez użytkownika, a następnie wysyła je do serwera za pomocą metody {@linkplain ServerController#sendLoginInfoToServer(String, String)}
     * następnie metoda obiera informację zwrotną od serwera, jeżeli serwer zaakceptował wprowadzone dane użytkownik informowany jest o prawidłowej rejestracji w przeciwnym wypadku, jeżeli
     * nie nastąpiło zerwanie połączenia użytkownik informowany jest o zarejestrowanym już adresie mailowym
     * @see RegulationsController
     * @see RegisterFormController#register()
     * @see ServerController#sendRegisterInfoToServer(String, String, String, String, LocalDate, String, java.sql.Date)
     * @see ServerController#getRegisterFeedBackFromServer()
     * @author Karol Przygoda
